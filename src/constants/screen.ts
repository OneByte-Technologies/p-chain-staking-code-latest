...
export const taskConstants: ScreenConstantsInterface = {
  ...
  'Export assets from C-chain to P-chain': 'CP',
  'Import assets from C-chain to P-chain': 'CP',
  'Export assets from P-chain to C-chain': "PC",
  'Import assets from P-chain to C-chain': "PC",
